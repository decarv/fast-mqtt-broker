 ...
 *
 * Author - Henrique de Carvalho <henriquecarvalho@usp.br>
 */
...
{
	//pthread_t thread_id;
	//pthread_create(&thread_id, NULL, sender_thread, NULL);
    ...
    LOG(INFO, "MQTT Broker v.%s. Ctrl-C to kill.\n", MQTT_VERSION);
    ...
    while (true) {
		...
		// TODO: this should be the accept_thread
        ...
        if (connfd < 0) {
            ...
            if (pid < 0) {
				...
				// TODO: this should be the session init thread
